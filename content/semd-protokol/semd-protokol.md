...
1. **Авторизация и навигация**  
   ...
   ![Картинка](../elenaspetr-cyber/quartz/content/semd-protokol/1.png)
...
2. **Работа с записью приёма**  
   ...
   ![Картинка](../elenaspetr-cyber/quartz/content/semd-protokol/2.png)

3. **Формирование документов**  
   Перейдите на вкладку **«Документы»** и нажмите кнопку **«Сформировать и подписать документы (СЭМД)»**.
   ![Картинка](../elenaspetr-cyber/quartz/content/semd-protokol/3.png)
...
4. **Проверка и подписание**  
   ...
   ![Картинка](../elenaspetr-cyber/quartz/content/semd-protokol/4.png)
